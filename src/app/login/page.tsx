        ...
        <Card variant="bordered" padding="lg">
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-gray-200 dark:border-gray-800 dark:border-gray-700" />
            </div>
...
// Wrapping in Suspense prevents the "not a React component" crash in Next.js 14
