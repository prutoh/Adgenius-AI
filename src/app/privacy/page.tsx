    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">1. Information We Collect</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">2. How We Use Your Information</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">3. Sharing Your Information</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">4. Data Retention</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">5. Your Rights</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">6. Security</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">7. Contact Us</h2>
