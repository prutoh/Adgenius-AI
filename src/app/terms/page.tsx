    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">2. Description of Service</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">3. User Accounts</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">4. Subscriptions and Payments</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">5. Acceptable Use</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">6. Intellectual Property & AI Output</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">7. AI Disclaimer</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">8. Limitation of Liability</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">9. Changes to Terms</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-8">10. Contact Us</h2>
