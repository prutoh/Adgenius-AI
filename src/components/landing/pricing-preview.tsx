    ...
    async (planId: 'pro' | 'unlimited') => {
      ...
      try {
        ...
        if (typeof window !== 'undefined') {
          sessionStorage.setItem('paypal_pending_order', JSON.stringify({ orderId: data.orderId, planId, interval: 'monthly' }))
        }
    ...
    <section id="pricing" className="py-24 bg-white dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-auto space-y-3">
                  {isCurrentPlan ? (
                    ...
                    <Button
                      ...
                      className="w-full"
                      size="lg"
                      onClick={() => { window.location.href = `/signup?redirect=/pricing?plan=${plan.id}` }}
                    >
                      Get Started
                    </Button>
                  ) : (
                    <>
                      ...
                      <Button
                        ...
                        className="w-full"
                        size="lg"
                        onClick={() => handlePayPalCheckout(plan.id as 'pro' | 'unlimited')}
                        ...
                        icon={
                          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M21.222 6.917c-.93 4.778-4.005 7.201-9.138 7.201h-2.19a.563.563 0 0 0-.556.479l-1.187 7.527h-.506l-.24 1.516a.56.56 0 0 0 .554.647h3.882c.46 0 .85-.334.922-.788l.06-.26.96-6.09.062-.336a.932.932 0 0 1 .923-.788h.58c3.76 0 6.705-1.528 7.565-5.946.36-1.847.174-3.388-.777-4.471a3.627 3.627 0 0 0-.714-.751z" fill="#0070E0" />
                            <path d="M8.73 7.17a.925.925 0 0 1 .36-.078h5.36c.634 0 1.228.042 1.775.13.155.025.307.054.455.088.148.034.292.073.432.117a4.87 4.87 0 0 1 .569.2c.93 4.778-4.006 7.2-9.138 7.2h-2.19a.563.563 0 0 0-.556.48l-1.262 7.998a.296.296 0 0 1-.293.248h-3.06a.467.467 0 0 1-.461-.539L2.84 1.244a.558.558 0 0 1 .552-.468h5.36c.434 0 .8.316.87.745l.108.65z" fill="#003087" />
                            <path d="M17.185 7.21a6.97 6.97 0 0 0-.455-.088 11.27 11.27 0 0 0-1.775-.13h-5.36a.925.925 0 0 0-.91.775l-1.145 7.25-.033.21a.563.563 0 0 1 .555-.48h2.19c5.132 0 8.208-2.422 9.138-7.2a4.87 4.87 0 0 0-.569-.2 8.043 8.043 0 0 0-.636-.137z" fill="#0070E0" />
                          </svg>
                        }
                      >
                        Pay with PayPal
        ...
        <div className="text-center mt-8">
          <Link href="/pricing" className="text-brand-600 dark:text-brand-400 hover:underline text-sm font-medium">
